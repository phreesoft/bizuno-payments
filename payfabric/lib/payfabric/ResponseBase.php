...
class payFabric_ResponseBase extends payFabric_ServiceBase
{
     ...
     *
     * If there is a problem with the request that the PayFabric! API has detected,
    ...
    public function getMessage()
    {
        ...
        } elseif ((isset($this->response["errorMsg"])) && (strlen($this->response["errorMsg"]) > 0)) {
    ...
    /**
     * Gets the Order ID created by PayFabric!
     * @return string
     */
    ...
    /**
     * Gets the Transaction ID created by PayFabric!
     * @return string
     */
    ...
    /**
     * Gets the credit card token created by PayFabric!
     * @return string
     */
    public function getToken()
    {
        if ((isset($this->response["save-on-file"]["token"])) && (strlen($this->response["save-on-file"]["token"]) > 0)) {
            ...
            return $this->response["result"]["token"];
        }
    }
    ...
    /**
     * Gets the Customer ID created by PayFabric!
     * @return string
     */
    ...
    {
        if ((isset($this->response["brandCode"])) && (strlen($this->response["brandCode"]) > 0)) {
            return $this->response["brandCode"];
        }
    }
    ...
    {
        if ((isset($this->response["brandMessage"])) && (strlen($this->response["brandMessage"]) > 0)) {
            return $this->response["brandMessage"];
        }
    }
    ...
    {
        if ((isset($this->response["brandTransactionID"])) && (strlen($this->response["brandTransactionID"]) > 0)) {
            return $this->response["brandTransactionID"];
        }
    }
